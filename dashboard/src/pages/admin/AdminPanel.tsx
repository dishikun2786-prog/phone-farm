...
import { Key, Layers, Play, ShieldCheck, BarChart3, Bell, Server } from 'lucide-react';
...
const ADMIN_MODULES = [
  ...
  { key: 'audit', label: '审计日志', desc: '按时间/设备/操作类型筛选查询', icon: ShieldCheck, path: '/admin/audit', color: 'text-orange-600 bg-orange-50 dark:bg-orange-900/30' },
